...
describe('Chain helpers', function () {
    it('getChainName', function () {
        ...
        chai_1.expect(chain_1.getChainName(src_1.ChainId.Avalanche)).to.eq('Avalanche');
    });
    it('isTestChain', function () {
        ...
        chai_1.expect(chain_1.isTestChain(src_1.ChainId.Avalanche)).to.be["false"];
    });
    it('isLocalChain', function () {
        ...
        chai_1.expect(chain_1.isLocalChain(src_1.ChainId.Fantom)).to.be["false"];
        chai_1.expect(chain_1.isLocalChain(src_1.ChainId.Avalanche));
    });
